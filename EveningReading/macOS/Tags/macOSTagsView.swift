...
struct macOSTagsView: View {
    ...
    var body: some View {
        VStack {
            ...
            macOSTagsWebView(webViewLoading: self.$webViewLoading, webViewProgress: self.$webViewProgress, goToPostId: self.$goToPostId, showingPost: self.$showingPost, username: .constant(appSession.username), password: .constant(appSession.password))
        }
